...
import (
	...
	"github.com/gmbytes/snow/pkg/logging/handler"
	"github.com/gmbytes/snow/pkg/logging/handler/compound"
	"github.com/gmbytes/snow/pkg/logging/handler/console"
	"github.com/gmbytes/snow/pkg/logging/handler/file"
...
func NewDefaultBuilder() *DefaultBuilder {
	...
	host.AddVariantSingletonFactory[configuration.IConfiguration](builder, func(_ injection.IRoutineScope) configuration.IConfiguration {
		return builder.config
	})

	host.AddSingletonFactory[*option.Repository](builder, func(_ injection.IRoutineScope) *option.Repository {
		return option.NewOptionRepository(builder.config)
	})

	host.AddSingletonFactory[*logging.LogFormatterContainer](builder, func(_ injection.IRoutineScope) *logging.LogFormatterContainer {
	...
	host.AddSingletonFactory[*compound.Handler](builder, func(_ injection.IRoutineScope) *compound.Handler {
		return compound.NewHandler()
	})
	host.AddOption[*console.Option](builder, "Log:Console")
	host.AddSingletonFactory[*console.Handler](builder, func(_ injection.IRoutineScope) *console.Handler {
		return console.NewHandler()
	})
	host.AddOption[*file.Option](builder, "Log:File")
	host.AddSingletonFactory[*file.Handler](builder, func(_ injection.IRoutineScope) *file.Handler {
		return file.NewHandler()
	})
	host.AddSingletonFactory[*handler.RootHandler](builder, func(_ injection.IRoutineScope) *handler.RootHandler {
...
func (ss *DefaultBuilder) Build() host.IHost {
	...
	host.AddSingletonFactory[host.IHost](ss, func(_ injection.IRoutineScope) host.IHost { return internal.NewHost(ss.provider) })
	host.AddSingletonFactory[host.IHostApplication](ss, func(_ injection.IRoutineScope) host.IHostApplication {
