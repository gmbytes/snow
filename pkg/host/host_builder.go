...
func AddKeyedOption[T any](builder IBuilder, key, path string) {
	repo := injection.GetRoutine[*option.Repository](builder.GetRoutineProvider())
...
func AddKeyedSingletonFactory[U any](
	builder IBuilder, key any, factory func(scope injection.IRoutineScope) U,
) *injection.RoutineDescriptor {
	return addKeyed[U, U](builder, key, factory, injection.Singleton)
}
func AddVariantKeyedSingletonFactory[T, U any](
	builder IBuilder, key any, factory func(scope injection.IRoutineScope) U,
) *injection.RoutineDescriptor {
...
func AddVariantKeyedScopedFactory[T, U any](
	builder IBuilder, key any, factory func(scope injection.IRoutineScope) U,
) *injection.RoutineDescriptor {
...
func AddKeyedTransientFactory[U any](
	builder IBuilder, key any, factory func(scope injection.IRoutineScope) U,
) *injection.RoutineDescriptor {
	return addKeyed[U, U](builder, key, factory, injection.Transient)
}
func AddVariantKeyedTransientFactory[T, U any](
	builder IBuilder, key any, factory func(scope injection.IRoutineScope) U,
) *injection.RoutineDescriptor {
...
func addKeyed[T, U any](
	...
	if factory == nil {
		untypedFactory = func(_ injection.IRoutineScope) any {
